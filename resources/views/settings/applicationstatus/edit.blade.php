        ...
        <div class="col-12">
            ...
            <!-- /.card-header -->
                <div class="card-header">
                    <h2 class="card-title">{{ $application_status->name }}</h2>
                </div>
                <div class="card-body">
                    ...
                    @endif
                    <form action="{{ route('applications.update', $application_status->id) }}" method="POST" class="mb-0">
                        @csrf
                        @method('put')
                        <div class="form-group">
                            <label for="exampleInputEmail1">Form Group Name</label>
                            <input class="form-control" type="text" name="name" value="{{$application_status->name}}" placeholder="" required>
                        </div>
                        <div class="form-group">
                            <label>Form Group Description</label>
                            <textarea class="form-control" rows="2" name="description" placeholder="">{{$application_status->description}}</textarea>
                        </div>
            ...
            <!-- /.card-header -->
                <div class="card-header">
                    <h3 class="card-title">{{ $application_status->name }}</h3>
                        ...
                        <div class="acc_head">
                            ...
                            <div class="actions">
                                <form action="{{ route('input.destroy',$item->id) }}" method="POST" style="float: right">
                                    @csrf
                                    @method('delete')
                                    <button type="submit" class="btn btn-danger" onclick="return confirm('Do you really want to delete this form input?');"><i class="fas fa-trash-alt"></i></button>
                                </form>
                            </div>
                        </div>
