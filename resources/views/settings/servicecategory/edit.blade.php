                ...
                <div class="card-body">
                    <form action="{{ route('service-category.update', $service_category->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="name" value="{{ $service_category->name }}" required>
                        </div>
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control summer_note" rows="3" name="description" >{{ $service_category->description }}</textarea>
                        </div>
